    ...
    $.extend(o, {
        ...
        {       
            ...
            $('#uipv_left_'+targetId).css({
                ...
                //'background': 'transparent url(images/UIPickerView/uipv_left_bg.png) no-repeat top',
                'float': 'left',
                'position': 'absolute',
                'margin': '0px',
                'z-index': '12'
            ...
            $('#uipv_top_'+targetId).css({
                'width': controlWidth-8 + 'px',
                'height': '80px',
              //  'background': 'transparent url(images/UIPickerView/uipv_top_bg.png) repeat-x top',
                'float': 'left',
                'position': 'absolute',
                'margin-left': '4px',
                'z-index': '12'
            ...
            $('#uipv_bottom_'+targetId).css({
                'width': controlWidth-8 + 'px',
                'height': '80px',
              //  'background': 'transparent url(images/UIPickerView/uipv_bottom_bg.png) repeat-x top',
                'float': 'left',
                'position': 'absolute',
                'margin-top': '80px',
                'margin-left': '4px',
            ...
            $('#uipv_right_'+targetId).css({
                'width': '4px',
                'height': '160px',
               // 'background': 'transparent url(images/UIPickerView/uipv_right_bg.png) no-repeat top',
                'float': 'right',
                'position': 'absolute',
            ...
            $('#uipv_bar_'+targetId).css({
                'width': controlWidth-8 + 'px',
                'height': '45px',
                //data.options.imgRoot
              //  'background': 'transparent url(images/UIPickerView/uipv_bar_bg.png) repeat-x top',
                'float': 'left',
                'position': 'absolute',
                'margin-top': '58px',
                'margin-left': '4px',
